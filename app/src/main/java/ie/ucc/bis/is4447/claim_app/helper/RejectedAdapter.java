...
public class RejectedAdapter extends RecyclerView.Adapter<RejectedAdapter.ClaimViewHolder>{
    ...
    public RejectedAdapter(Context mCtx, List<Claim> claimList) {
        this.mCtx = mCtx;
    ...
    @Override
    public RejectedAdapter.ClaimViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.reject_list, null);
        return new RejectedAdapter.ClaimViewHolder(view);
    }
